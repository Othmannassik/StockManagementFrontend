...
import { Commande } from '../sections/@dashboard/commande/commande';
import '../sections/@dashboard/commande/index';
...
export default function LazyLoadDemo() {
    ...
    const loadLazyData = () => {
        ...
        networkTimeout = setTimeout(() => {
            Commande.getCustomers({ lazyEvent: JSON.stringify(lazyState) }).then((data) => {
    ...
    const onSelectAllChange = (event) => {
        ...
        if (selectAll) {
            Commande.getCustomers().then((data) => {
                setSelectAll(true);

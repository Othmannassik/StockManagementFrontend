...
export default function MaterielsDemo() {
    ...
    useEffect(() => {
        TypeMaterielService.getMateriels().then((data) => setMateriels(data));
    }, []);
        ...
        <div>
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={materiels} selection={selectedMateriels} onSelectionChange={(e) => setSelectedMateriels(e.value)}
                    ...
                    <Column field="model" header="Name" sortable style={{ minWidth: '12rem' }} />
            ...
            <Dialog visible={materielDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Matériel Détails" modal className="p-fluid" footer={materielDialogFooter} onHide={hideDialog}>
                <div className="field">
                    ...
                    <InputText placeholder='Name' id="model" value={materiel.model} onChange={(e) => onInputChange(e, 'model')} required autoFocus className={classNames({ 'p-invalid': submitted && !materiel.model })} />
